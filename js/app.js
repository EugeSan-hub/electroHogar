    ...
    contenedorDetalle.innerHTML = `
        <div class="row">
          <div class="col-sm-12 col-md-6 col-xl-8">
            <img src="${productoEncontrado.imagen}" alt="${productoEncontrado.nombre}" class="img-fluid h-100" />
          </div>
          <div class="col-sm-12 col-md-6 col-xl-4 rounded-2">
            <h2 class="text-dark">${productoEncontrado.nombre}</h2>
            <h6 class="text-secondary mb-3 fw-lighter fs-5">
              Venta de electrodomésticos verificada
              <i class="bi bi-patch-check-fill text-primary"></i>
            </h6>
            <h3 class="text-dark">$${productoEncontrado.precio}</h3<h5 class="text-dark mt-3">${productoEncontrado.descripcion}</h5>
           <div>
             <a href="../pages/Error404.html" class="btn btn-primary btn-lg fw-light">Comprar</a>
           </div>
         </div>
        </div>`;
 }
